<h2><a href="https://leetcode.com/problems/word-subsets/">916. Word Subsets</a></h2><h3>Medium</h3><hr><div bis_skin_checked="1"><p>You are given two string arrays <code>words1</code> and <code>words2</code>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> words1 = ["amazon","apple","facebook","google","leetcode"], words2 = ["e","o"]
...
<pre style="position: relative;"><strong>Input:</strong> words1 = ["amazon","apple","facebook","google","leetcode"], words2 = ["l","e"]
