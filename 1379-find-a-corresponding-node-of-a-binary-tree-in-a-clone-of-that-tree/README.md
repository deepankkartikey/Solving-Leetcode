...
<pre style="position: relative;"><strong>Input:</strong> tree = [7,4,3,null,null,6,19], target = 3
...
<pre style="position: relative;"><strong>Input:</strong> tree = [7], target =  7
<strong>Output:</strong> 7
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper" bis_skin_checked="1"></div></pre>

<p><strong>Example 3:</strong></p>
<img alt="" src="https://assets.leetcode.com/uploads/2020/02/21/e3.png" style="width: 459px; height: 486px;">
<pre style="position: relative;"><strong>Input:</strong> tree = [8,null,6,null,5,null,4,null,3,null,2,null,1], target = 4
